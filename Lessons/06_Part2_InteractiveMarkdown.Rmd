...
```{r setup, echo=FALSE, echo=FALSE, eval=FALSE, warning=FALSE, message=FALSE}
#Load packages
...
renderPlot(plot_it(input$the_paramter, 
                   input$YearSlider[1], 
                   input$YearSlider[2])) #why wont my widget plot?
```

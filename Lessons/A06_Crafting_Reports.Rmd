---
title: 'BrookHemphill_A06_CraftingReports.Rmd'
...
Date  | 2018 - 2019
Filename  | EPA Air Quality System (AQS)
...
```{r echo=FALSE, warning=FALSE, fig.height=3, fig.width=5, fig.cap = "2018 Ozone values by month"}
...
ggplot(epa_data_2018, aes(x = Month, y = Ozone)) +
  geom_boxplot() +
  labs(title = "Distribution of Ozone Levels by Month in 2018",
       x = "Month",
       y = "Ozone Levels (ppm)")

```

```{r echo=FALSE, warning=FALSE, fig.height=3, fig.width=5, fig.cap = "2019 Ozone values by month"}
...
ggplot(epa_data_2019, aes(x = Month, y = Ozone)) +
  geom_boxplot() + 
  labs(title = "Distribution of Ozone Levels by Month in 2019",
       x = "Month",
       y = "Ozone Levels (ppm)")

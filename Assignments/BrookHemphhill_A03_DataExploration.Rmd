...
#Load datasets 
#ECOTOX_neonicotinoid <- read.csv("./Data/Raw/ECOTOX_Neonicotinoids_Insects_raw.csv",stringsAsFactors = TRUE) 

#Niwot_Ridge_NEON <- read.csv("./Data/Raw/NEON_NIWO_Litter_massdata_2018-08_raw.csv",stringsAsFactors = TRUE) 
...
> Answer:The class is factor. ASK WHY NOT NUMERIC!**
...
```{r}
ggplot(ECOTOX_neonicotinoid, aes(x = Publication.Year, color = Test.Location)) +
...
Niwot_Ridge_NEON$collectDate <- as.Date(Niwot_Ridge_NEON$collectDate, format = "%Y-%m-%d")
